...
P.skn = function() {
    ...
    if (tm) {
        var n = $("body"),
        f = $(window.frames['mainFrame'].document).find('body');
...
$(document).ready(function() {
    var $left = $("#left"),
    lfet_no_overflow = $left.data("no_overflow");
    if (!lfet_no_overflow) {
        $left.niceScroll();
    }
    $("#left div.subnav-title").click(function() {
        ...
        if (_ico.hasClass("fa fa-angle-right")) {
            _ico.attr("class", "fa fa-angle-down");
        } else {
            _ico.attr("class", "fa fa-angle-right");
        };
        _sib_p.children("ul.subnav-menu").slideUp("slow");
        //_sib_p.find("i").attr("class", "icon-angle-right");
        var xx = _sib_p.find("a").find('i');
        xx.each(function(i, ite) {
            if ($(ite).hasClass("fa fa-angle-down")) {
                $(ite).attr("class", "fa fa-angle-right");
            }
        });
    ...
    function() {
        ...
        f.attr("data-theme") !== undefined ? f.attr("class", "").addClass(f.attr("data-theme")) : f.attr("class", "");
    }).click(function() {
        var e = $(this),
        f = $(window.frames['mainFrame'].document).find('body');
        ...
        $.cookie('data-theme', "theme-" + e.attr("class"), {
            expires: 365
        });
    });
...
var lfet_select_menu = function(index) {
    ...
    var $pi = $ul.parent();
    var _ico = $pi.find("i");
    _ico.each(function(i, ite) {
        if ($(ite).hasClass("fa fa-angle-right")) {
            $(ite).attr("class", "fa fa-angle-down");
        }
    });
    /*if (_ico.hasClass("fa fa-angle-right")) {
        _ico.attr("class", "fa fa-angle-down");
    ...
    //_sib_p.find("i").attr("class", "fa fa-angle-right");
    _sib_p.find("a").removeClass("active");
    $("#left").find("li").removeClass("active");
    _sib_p.children("ul.subnav-menu").slideUp("slow");
    $ul.slideDown();
